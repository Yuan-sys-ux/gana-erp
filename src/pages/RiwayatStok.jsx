      ...
      <div className="flex flex-col gap-6 font-sans">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 bg-white p-3 rounded-xl shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)] border border-[#E2E8F0]">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
            {/* Month Filter */}
            <select className="border border-[#E2E8F0] rounded-lg px-3 py-2 text-xs font-semibold text-[#475569] focus:outline-none focus:ring-1 focus:ring-[#4F46E5] bg-white h-9">
