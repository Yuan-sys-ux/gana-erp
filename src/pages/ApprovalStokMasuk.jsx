...
import { ShieldCheck, XCircle, CheckCircle2, Clock, Search, ChevronDown, ChevronUp, AlertCircle } from 'lucide-react';
      ...
      <div className="flex flex-col gap-6 font-sans">
        ...
        <div className="flex flex-col gap-4">
          {filteredApprovals.length > 0 ? (
            ...
            <div className="bg-white rounded-2xl p-10 border border-[#E2E8F0] shadow-sm text-center flex flex-col items-center justify-center gap-3">
              <div className="w-12 h-12 rounded-full bg-[#F1F5F9] text-[#64748B] flex items-center justify-center">
                <AlertCircle className="w-6 h-6" />
              </div>
              <div>
                <p className="text-sm font-bold text-[#1E293B]">Tidak Ada Penerimaan Stok</p>
                <p className="text-xs text-[#64748B] mt-1">Saat ini tidak ada data stok masuk yang perlu diproses atau ditampilkan.</p>
              </div>
            </div>
          )}
        </div>
